...
**부제:** 일정 관리 · NAS 파일 연동 · L&F Wiki 통합
**발표일:** 2026년 4월
...
| VOC 자동 축적 | IT 지원 완료 건을 매일 자동 분류(16개 카테고리) → Wiki 문서화 |
| 접근 권한 연동 | Outline 권한 체계 그대로 반영, 미허용 문서는 검색 결과에서 제외 |

**VOC 자동 축적 흐름:**
매일 06시 → VOC 완료 건 수집 → AI가 시스템/주제별 자동 분류 → 기존 문서 병합 또는 신규 생성 → Wiki 발행 + 목차 업데이트 → 결과 메일 발송
...
**일정 · 파일 · 지식을 직접 다루는 업무 보조 에이전트**로 진화하고 있습니다.# Lucid AI 챗봇 — 신규 기능 보고 슬라이드 컨텐츠
...
| 기능 | 설명 |
|------|------|
| 문서 검색 | 키워드 + 시맨틱# Lucid AI 챗봇 — 신규 기능 보고 슬라이드 컨텐츠
...
| 문서 열람/생성/수정 | 자연어로 Wiki 문서 CRUD |
| 파일 → Wiki 발행 | PDF/PPT/DOCX를 마크다운 변환하여 Wiki에 자동 게시 |
| 임베드 위젯 | Outlin# Lucid AI 챗봇 — 신규 기능 보고 슬라이드 컨텐츠
...
Lucid AI 챗봇은 단순한 대화 도구에서
**일정 · 파일 · 지식을 직접 다루는 업무 보조 에이전트**로 진화하고 있습니다.e Wiki 화면 내 AI 채팅창 내장, Wiki 문맥에 특화 |
| VOC 자동 축적 | IT 지원 완료 건을 매일 자동 분류(16개 카테고리) → Wiki 문서화 |
| 접근 권한 연동 | Outline 권한 체계 그대로 반영, 미허용 문서는 검색 결과에서 제외 |
...
Lucid AI 챗봇은 단순한 대화 도구에서
**일정 · 파일 · 지식을 직접 다루는 업무 보조 에이전트**로 진화하고 있습니다. 하이브리드 검색 (의미 기반 매칭 포함) |
| 문서 열람/생성/수정 | 자연어로 Wiki 문서 CRUD |
| 파일 → Wiki 발행 | PDF/PPT/DOCX를 마크다운 변환하여 Wiki에 자동 게시 |
| 임베드 위젯 | Outline Wiki 화면 내 AI 채팅창 내장, Wiki 문맥에 특화 |
| VOC 자동 축적 | IT 지원 완료 건을 매일 자동 분류(16개 카테고리) → Wiki 문서화 |
...
Lucid AI 챗봇은 단순한 대화 도구에서
**일정 · 파일 · 지식을 직접 다루는 업무 보조 에이전트**로 진화하고 있습니다.
---
